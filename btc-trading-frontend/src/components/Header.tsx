...
import { FaBitcoin, FaSync, FaCircle } from 'react-icons/fa';
        ...
        <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-sm text-gray-400">Multi-Timeframe Analysis</p>
            </div>
          </div>
          ...
          <div className="flex flex-col md:flex-row items-start md:items-center gap-4">
            {/* Current Price */}
            <div className="bg-blue-900 bg-opacity-50 px-6 py-3 rounded-lg border border-blue-600">
